...
export const MediaSidebar = memo(function MediaSidebar() {
  ...
  const allCategories = [
    ...
    { id: 'text' as const, icon: Type, label: 'Text', feature: 'text' as const },
    { id: 'shapes' as const, icon: Pentagon, label: 'Shapes', feature: 'shapes' as const },
    { id: 'effects' as const, icon: Layers, label: 'Effects', feature: 'effects' as const },
    { id: 'transitions' as const, icon: Blend, label: 'Transitions', feature: 'transitions' as const },
  ];

  // Filter categories based on feature flags
  const categories = allCategories.filter((cat) => {
    if (cat.feature) {
      return isFeatureEnabled(cat.feature);
    }
    return true; // Always show 'media'
  });
